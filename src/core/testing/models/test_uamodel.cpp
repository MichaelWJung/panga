...
#include "core/models/uamodel.h"

//struct UaModelFixture
//{
...
//    std::shared_ptr<ParameterAccessor>   ua_accessor;
//    std::shared_ptr<DerivativeCollector> ua_collector;
//
...
//        ua_accessor     (model->GetParameterAccessor()),
//        ua_collector    (model->GetDerivativeCollector()),
...
//        ua_accessor    ->SetVectorReference(parameters);
//    }
//
//    ~UaModelFixture()
//    {
...
//};
//
//BOOST_FIXTURE_TEST_SUITE(UaModel_tests, UaModelFixture)
//
//BOOST_AUTO_TEST_CASE(CalculateConcentration)
//{
//    BOOST_CHECK(boost::math::isnan(model->CalculateConcentration(0, ua_accessor, Gas::HE)));
//
//    T = 10;
//    S = .1;
//    p = 1;
...
//    ua_collector    ->SetDerivativesAndResultsVector(derivatives, indices);
//
//    T = 10;
//    S = .1;
//    p = 1;
